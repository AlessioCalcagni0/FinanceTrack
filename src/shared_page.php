...
<head>
    ...
    <link rel="stylesheet" href="shared_page.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
    <link rel="manifest" href="/manifest.json">
    <script> const API_HOST = "<?php echo $apiHost; ?>";</script>
    <script src="shared_page.js"></script>
...
<body>
    ...
    <div class="navbar">
        ...
        <div  id="title">Shared Wallet</div>
    ...
    <div class="main">
        <div class="account-summary">
            ...
            <div class="balance">
                <div class="balance-left">
                    ...
                    <div class="personal-title">Personal Balance</div>
        ...
        <div class="recent-transaction-label"> Recent transactions</div>
        ...
        <button id="cashBtn" onclick="redirect('/add_sw_trans.php')">
