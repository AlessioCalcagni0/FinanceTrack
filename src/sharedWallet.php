...
<body>
    ...
    <div class="navbar">
        ...
        <div class="dropdown">
            ...
            <div id="menu-content" class="dropdown-content">
                ...
                <h2>Goals</h2>
                <a href="/insights.php">Overview</a>
    ...
    <div class="main">
        ...
        <div class="account-list-label"> Shared wallets list:</div>

        <div class="super-frame">
            <!-- ID aggiornato -->
            <div class="frame-account" id="frame-accounts"></div>
        ...
        <div id="swEditPopup"></div>
           ...
           <!-- Bottone centrale -->
        <button id="createSwBtn" class="createSwBtn">Create Shared Wallet</button>
         
        <div class="home-container">
            <div class="home active" onclick="openTab('friends', this)" id="friend">Friends</div>
        </div>
         ...
         <div id="friends" class="home-content">
            <div class="home-card">
                ...
                <div class="fc-dots" aria-label="pagination"></div>

                <button id="invite-friend-btn">Invite a friend</button>
            </div>
            </div>
        ...
        <!-- Pending Invitations -->
            ...
            <h3 class="invites-title">Received pending Invitations</h3>

            <div class="invites-carousel">
                <button class="iv-arrow iv-prev" aria-label="Previous">&#10094;</button>

                <div class="iv-viewport">
                <div class="iv-track"><!-- cards generate via JS --></div>
                </div>

                <button class="iv-arrow iv-next" aria-label="Next">&#10095;</button>
            </div>

            <div class="iv-dots" aria-label="pagination"></div>
            <!-- toast in basso (se non l’hai già) -->
            <div id="invite-toast" class="iv-toast" role="status" aria-live="polite"></div>
            </div>
