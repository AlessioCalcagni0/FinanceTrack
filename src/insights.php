    ...
    <div id="topbar"></div>
        ...
        <div id="main" class="main">
            <div class="chart-container">
                ...
                <!-- Bar Chart -->
                <canvas id="main-chart" style="margin-top:30px; " width="350" height="300"></canvas>
                <!-- Line Chart -->
                <canvas id="line-chart" style="margin-top:30px; "  width="350" height="300"></canvas>
            </div>
        </div>
