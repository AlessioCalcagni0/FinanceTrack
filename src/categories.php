...
<body>
    ...
    <div class="navbar">
        ...
        <div class="dropdown">
            ...
            <div id="menu-content" class="dropdown-content">
                ...
                <a onclick="closeMenu()">Spending by Category</a>
                <h2>Goals</h2>
    ...
    <div class="main">
        ...
        <div class="search-bar">
                <input type="text" id="search" placeholder="Search a category" oninput="search()"> 
                <button onclick="search()"> <i class="fas fa-search" ></i></button>
        </div>
        <div class="frame-category">
            <div class="label-category"> 
                <h2 id="name-label"> Category name</h2>
                <h2 id="limit-label"> Limit</h2>
                <h2 id="spent-label">Spent </h2>
            </div>
        ...
        <div class="add-category-button" onclick="openPopup('category-popup','overlay')"> + Add a category</div>
        
        <h2 class="chart-title">Expenses by category</h2>
            <div class="chart-section">
            <!-- i due label di selezione -->
                <div class="chart-tabs">
                    <button class="chart-tab active" data-target="pie">Pie</button>
                    <button class="chart-tab" data-target="bar">Bar</button>
                </div>

                <!-- contenitore grafici -->
                <div class="chart-container">
                    <div class="chart-controls">
                        <button class="period-btn" data-periodo="anno">Year</button>
                        <button class="period-btn" data-periodo="mese">Month</button>
                        <button class="period-btn active" data-periodo="settimana">Week</button>
                    </div>
                    <div class="box-chart" id="chart-pie">
                        <canvas id="myChart" width="400" height="400"></canvas>
                    </div>
                    <div class="box-chart" id="chart-bar" style="display:none;">
        ...
        <div class="category-popup" id="category-popup">
            ...
            <h2> Select the icon</h2>
            <div class="choose-icon">
                <div class="icon" id = "computer" > 
                </div>
                <div class="icon" id = "travel">
                </div>
                <div class="icon" id = "cash"> 
                </div>
                <div class="icon" id = "medical">
                </div>
            </div>
            <h2> Choose the name </h2>
            <input class="number_input"placeholder="Enter the name of the category">
            <h2> Select the limit </h2>
            <input class="number_input" placeholder="Enter the limit for the category">
            <h2> Select the spent import (Optional)</h2>
            <input class="number_input" placeholder="Enter the money spent">
            <div class="end_operation">
                <button class="cancel_button" onclick="closePopup('category-popup','overlay')">Cancel</button>
        ...
        <div class="warning-overlay" id="warning-overlay">
            <div class="warning-category-popup"> 
                <h3 id="warning-message">Please fill all non-optional fields including selecting the icon to add a category</h3>
                <button class="confirm_button" id="OK">OK</button>
            </div>
        </div>
